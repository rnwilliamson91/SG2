...
## [RPGActorSprite2D] is an [AnimatedSprite2D] which automagically gets the [member RPGActorSprite2D.handle] rpg.actor and sets up its sprite sheet including animations.
